...
/**
 * 是所有blot（Inline、Block、Embed、Container等）的父类
 */
class ShadowBlot implements Blot {
  ...
  /**
   * 检查该Blot的requiredContainer是否被设置，并且该Blot的父Blot是不是requiredContainer设置的Blot类的实例，如果不是则调用wrap方法
   * @param _context 
   */
  ...
  /**
   * 创建容器Blot实例，插入到该Blot的父级中，然后将当前Blot插入到创建的容器中
   * @param name 
   * @param value 
   */
